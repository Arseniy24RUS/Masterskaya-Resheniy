...
*The course interface is currently Russian-only; the README is bilingual.*

![Animated demo of a lesson, interactive lab, exercise answer, and feedback](assets/visuals/readme/demo.gif)

*Demo: lesson explanation, interactive lab, exercise answer, and immediate feedback.*

![English architecture diagram for Masterskaya Resheniy](assets/visuals/readme/architecture-en.svg)

*Workflow diagram: static course content, interactive lab modules, browser session state, and publication files.*
...
*Интерфейс курса сейчас русскоязычный; README двуязычный.*

![GIF-демонстрация урока, интерактивной лаборатории, ответа на задание и обратной связи](assets/visuals/readme/demo.gif)

*Демонстрация: объяснение урока, интерактивная лаборатория, ответ на упражнение и немедленная обратная связь.*

![Русская схема архитектуры «Мастерской решений»](assets/visuals/readme/architecture-ru.svg)

*Схема: статический контент курса, интерактивные лаборатории, состояние сеанса браузера и файлы публикации.*
